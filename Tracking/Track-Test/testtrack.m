a = uint8(imread('c:\users\rdgroup\desktop\testtrack.tif')); % Read in image as unsigned 8 bit int
...
%colormap('jet')
scatter(cnt(:,1), cnt(:,2), 8, 'filled') % Plots scatter of points onto original imagesc
